...
> **QUICK TIP**   
> _If you want to test your Azure Function running with your local docker machine use the command: ``docker run -d -e AzureWebJobsStorage="UseDevelopmentStorage=true;DevelopmentStorageProxyUri=http://host.docker.internal" <IMAGE_NAME>``_
